...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "🗃️ <b>File Name: </b> ✧⋟  {file_caption} \n⚙️ <b>Size: </b><i>{file_size}</i>\n\n<b> ✨More updates - @MovesZoneUpdates </b> 🫀Main Channel- @MovesZoneBM")
...
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','+8qKEhKHt7eBhYTM1') # WITHOUT @
